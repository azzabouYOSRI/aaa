...
public class Prob {
	...
	// generates a graph matrix (avec la distance entre chaque piquet)
	...
	public static void resolveTSP(int start) {
		...
		while ((!leafQueue.isEmpty()) && (currentNode.getCityNumber() != 5)) {
